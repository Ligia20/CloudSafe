...
const Log:React.FC=()=> {
      ...
      try{
        ...
        setLogs(
          events.map((event:any)=>({
            ...
            asset:event.asset?.name||event.assetId||null,
            hostname:event.asset?.hostname||null,
            sourceIp:event.sourceIp||null,
            eventType:event.eventType||"Security Event",
  ...
  const filteredLogs=logs.filter(log=>{
    ...
    const assetName=
      log.asset?.toLowerCase().replace(/\s+/g,"-");
      ...
      <IonContent>
        ...
        <div className="search-bar-content">
          ...
          <IonSelect
            ...
            onIonChange={e=>
              setSelectedSeverity(e.detail.value)
            }
          >
